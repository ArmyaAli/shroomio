...
#ifndef IM_CHECK
#define IM_CHECK(expr) ShroomTe_Check(__FILE__, __func__, __LINE__, (bool)(expr), #expr)
#endif

#ifndef IM_CHECK_EQ
#define IM_CHECK_EQ(a, b)                                                                          \
  ShroomTe_CheckEq(__FILE__, __func__, __LINE__, (long long)(a), (long long)(b), #a, #b)
#endif

#ifndef IM_CHECK_STR_EQ
#define IM_CHECK_STR_EQ(a, b) ShroomTe_CheckStrEq(__FILE__, __func__, __LINE__, (a), (b), #a, #b)
#endif

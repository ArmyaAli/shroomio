...
\hline
Server / Logger & \texttt{src/server/logger.c}, \texttt{l\allowbreak ogger.h} & Structured logging with levels (DEBUG, INFO, WARN, ERROR, FATAL), timestamps, colored output, source location tracking \\
\hline
...
The data model consists of five core tables and two leaderboard views:
...
6. enet_host_create(&address, 128 clients, 3 channels)
